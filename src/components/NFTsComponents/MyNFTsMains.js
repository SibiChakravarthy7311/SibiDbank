...
import "./MyNFTsMain.css";
import ether from "./ether.png";
import KeyboardArrowDownIcon from '@mui/icons-material/KeyboardArrowDown';
import KeyboardArrowUpIcon from '@mui/icons-material/KeyboardArrowUp';


class MyNFTsMain extends Component {
    ...
    const nftData = (
      <div>
        ...
        //   console.log(image.author, this.props.account, image.author == this.props.account);
          return (
            <div>
                {image.author === this.props.account && !image.loanTaken && !image.inAuction ?
                                ...
                                <div>
                                    <div className="auctionPost">
                                      <button
                                          ...
                                          this.props.availLoan(event.target.name);
                                          }}
                                      >
                                          AVAIL LOAN
                                      </button>
